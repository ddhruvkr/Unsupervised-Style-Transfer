...
class DecoderGRU(nn.Module):
    def __init__(self, hidden_size, output_size, tag_size, dep_size, num_layers, embedding_weights, embedding_dim, tag_dim, dep_dim, dropout_p, use_structural_as_standard):
