...
class Lang:
	...
	def readLangs():
		...
		print(len(valid_x))
		print(len(test_x))
		return input_lang, train_x, train_y, valid_x, valid_y, test_x, test_y
...
def prepareData():
	input_lang, train_x, train_y, valid_x, valid_y, test_x, test_y = Lang.readLangs()
	...
	return input_lang, tag_lang, dep_lang, train_x, train_y, valid_x, valid_y, test_x, test_y, input_embedding_weights, tag_embedding_weights, dep_embedding_weights
